...
- полных эталонных ledgers: 17;
- адаптеров критических формул: 1;
- проверенных выражений: 295;
- всех находок: 3;
- статусы: `{'FAIL': 1, 'PASS': 17}`.
...
| `conical-intersections-observation-v1-1` | reference | 36 | 0 | 0 | 0 | 0 | **PASS** |
...
### Conical Intersections as Typed Spectral Singularities under Observation Maps (1.1.0)

Статус: **PASS**. Следующее действие: retain_as_spectral_gauge_nonadiabatic_observation_reference
